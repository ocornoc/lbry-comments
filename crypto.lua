...
print "Word:"
print(b64_encode(_M.new_sign_object():insert"sup":sign()))

print "Letter by letter:"
print(b64_encode(_M.new_sign_object():insert"s":insert"u":insert"p":sign()))

print "Regular sign:"
print(b64_encode(_M.sign"sup"))


print ""
print "Big data test"
local test_data = ("my cat is named bambi"):rep(1000)

print "Data:"
print(b64_encode(_M.new_sign_object():insert(test_data):sign()))

print "Byte by byte:"
local test_data_state = _M.new_sign_object()
for i = 1, test_data:len() do
	test_data_state:insert(test_data:sub(i, i))
end
print(b64_encode(test_data_state:sign()))

print "Regular sign:"
print(b64_encode(_M.sign(test_data)))
